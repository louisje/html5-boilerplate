...
nn.init(function($) {
    ...
    nn.when([
        ...
        ytDeferred
        , nn.load('http://www.gstatic.com/cast/js/receiver/1.0/cast_receiver.js')
        ...
        $('#btn_power').click(function() {
            if (y$.poweroff) {
                ...
                blank$.setBackground('./img/tv.jpg');
                blank$.show('電源已關閉');
...
var main = function() {
    ...
    var castChannelHandler = new cast.receiver.ChannelHandler('Scupio');
